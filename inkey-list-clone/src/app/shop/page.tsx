        ...
        <section className="mb-12">
          <div className="bg-[#efeff0] rounded-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Link href="/concerns/hydration" className="group">
                <div className="bg-white rounded-lg p-4 text-center hover:bg-[#746cad] hover:text-white transition-colors">
                  <div className="text-2xl mb-2">💧</div>
                  <h3 className="font-semibold font-inter text-sm">Hydration</h3>
                  <p className="text-xs opacity-75 mt-1">Plump & dewy skin</p>
                </div>
              </Link>
              <Link href="/concerns/anti-aging" className="group">
                <div className="bg-white rounded-lg p-4 text-center hover:bg-[#746cad] hover:text-white transition-colors">
                  <div className="text-2xl mb-2">✨</div>
                  <h3 className="font-semibold font-inter text-sm">Anti-Aging</h3>
                  <p className="text-xs opacity-75 mt-1">Reduce fine lines</p>
                </div>
              </Link>
              <Link href="/concerns/blemishes" className="group">
                <div className="bg-white rounded-lg p-4 text-center hover:bg-[#746cad] hover:text-white transition-colors">
                  <div className="text-2xl mb-2">🎯</div>
                  <h3 className="font-semibold font-inter text-sm">Blemishes</h3>
                  <p className="text-xs opacity-75 mt-1">Clear breakouts</p>
                </div>
              </Link>
              <Link href="/concerns/brightening" className="group">
                <div className="bg-white rounded-lg p-4 text-center hover:bg-[#746cad] hover:text-white transition-colors">
                  <div className="text-2xl mb-2">🌟</div>
                  <h3 className="font-semibold font-inter text-sm">Brightening</h3>
                  <p className="text-xs opacity-75 mt-1">Even skin tone</p>
                </div>
              </Link>
            </div>
            <div className="text-center mt-6">
              <Link href="/concerns/sensitive" className="inline-block">
                <div className="bg-white rounded-lg p-4 hover:bg-[#746cad] hover:text-white transition-colors">
                  <div className="text-2xl mb-2">💗</div>
                  <h3 className="font-semibold font-inter text-sm">Sensitive Skin</h3>
                  <p className="text-xs opacity-75 mt-1">Gentle & soothing</p>
                </div>
              </Link>
            </div>
          </div>
